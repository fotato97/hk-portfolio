...
소개 페이지에는 36.5도씨의 관심 분야, 배우는 것, 앞으로의 목표를 담았습니다. 기사는 예시이며 영상 페이지는 스토리보드입니다. 직접 MP4 또는 WEBM 파일을 추가하면 재생할 수 있습니다. 이미지 페이지는 AI로 생성한 한 작품과 CSS 색상·구도 변주입니다. GMarketSans 폰트 연결이 불가능해도 시스템 글꼴로 표시됩니다.
